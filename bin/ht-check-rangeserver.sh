...
usage() {
  echo
  echo "usage: ht-check-rangeserver.sh [OPTIONS] [<server-options>]"
  echo
  echo "OPTIONS:"
  ...
  echo
  echo "Checks the status of the RangeServer process.  This script is Nagios plugin"
  ...
  echo "format:"
  echo
  echo "  RangeServer <status> - <description>"
  echo
}
