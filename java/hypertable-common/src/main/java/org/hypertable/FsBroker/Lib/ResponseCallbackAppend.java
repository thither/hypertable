...
public class ResponseCallbackAppend extends ResponseCallback {

  ResponseCallbackAppend(Comm comm, Event event) {
    super(comm, event);
  }
  ...
  public int response(long offset, int amount) {
    ...
    CommBuf cbuf = new CommBuf(header, 5 + Serialization.EncodedLengthVInt32(12) + 12);
