...
function(HT_FASTLIB_SET)
	...
	if ((NOT HT_FASTLIB_SET_INCLUDE OR INCLUDE_DIRS) AND LIBRARY)
		...
		if(BUILD_SHARED_ALL_LIBS)
			set(SHARED_DEP "")
			foreach(lib ${${HT_FASTLIB_SET_NAME}_LIBRARIES})
				string(REPLACE ".a" "" lib ${lib})
				string(REPLACE "/" ";" lib ${lib})
				list(GET lib -1 lib)
				string(SUBSTRING ${lib} 3 -1 lib)
				set(SHARED_DEP "${SHARED_DEP} ${lib}")
			endforeach()
...
function(HT_ADD_TEST)
	...
	if (NOT BUILD_SHARED_LIBS AND HT_TEST_WITH STREQUAL "STATIC" OR HT_TEST_WITH STREQUAL "BOTH")
		if(HT_ADD_TEST_PRE_CMD_TYPE)
