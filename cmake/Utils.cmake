...
function(GET_TARGET_LINKS)
  ...
  foreach(TARGET ${OPT_TARGETS})
    ...
    GET_ARCHIVE_STATIC_LINKS(NAME ${TARGET} TARGETS ${STATIC_TARGETS} LINKS ${STATIC_LINKING})
  endforeach()
...
# -------------------------------
  ...
  #	LINKS 		    aggregated static links
  # )
# result:
#     STATIC_TARGETS and STATIC_LINKING set to parent-scope
# -------------------------------

function(GET_ARCHIVE_STATIC_LINKS)
  cmake_parse_arguments(OPT "" "NAME" "TARGETS;LINKS" ${ARGN})
  
  # message("GET_ARCHIVE_STATIC_LINKS: ${OPT_NAME}")
  get_property(targets GLOBAL PROPERTY ${OPT_NAME}-ARCHIVE_TARGETS)
  set(STATIC_TARGETS ${OPT_TARGETS} ${STATIC_TARGETS} ${OPT_NAME}-archive)

  get_property(target_static_links GLOBAL PROPERTY ${OPT_NAME}-ARCHIVE_STATIC)
  set(STATIC_LINKING ${OPT_LINKS} ${STATIC_LINKING} ${target_static_links})

  foreach(INNER_TARGET ${targets})
    GET_ARCHIVE_STATIC_LINKS(NAME ${INNER_TARGET} TARGETS ${STATIC_TARGETS} LINKS ${STATIC_LINKING})
  endforeach()
...
function(ADD_LIB_TARGET)
  ...
  set(STATIC_LINKING ${OPT_STATIC})
  set(STATIC_TARGETS )
  set(SHARED_LINKING ${OPT_SHARED} ${CORE_LIBS_SHARED} ${CORE_LIBS})
  set(SHARED_TARGETS )
  ...
  if(NOT OPT_ONLY_STATIC_SHARED AND LIBS_SHARED_LINKING STREQUAL "SHARED")
    target_link_libraries(${OPT_NAME}-shared LINK_PUBLIC ${SHARED_LINKING} ${SHARED_TARGETS})
  endif ()
