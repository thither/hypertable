...
var HqlService_hql_exec_args = function(args) {
  this.ns = null;
  this.command = null;
  this.noflush = false;
...
var HqlService_hql_exec_result = function(args) {
  this.success = null;
  this.e = null;
...
var HqlService_hql_query_args = function(args) {
  this.ns = null;
  this.command = null;
  if (args) {
    if (args.ns !== undefined && args.ns !== null) {
...
var HqlService_hql_query_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof Client_ttypes.ClientException) {
    this.e = args;
...
var HqlService_hql_exec_as_arrays_args = function(args) {
  this.ns = null;
  this.command = null;
  this.noflush = false;
  this.unbuffered = false;
...
var HqlService_hql_exec_as_arrays_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof Client_ttypes.ClientException) {
    this.e = args;
...
var HqlService_hql_exec2_args = function(args) {
  this.ns = null;
  this.command = null;
  this.noflush = false;
  this.unbuffered = false;
...
var HqlService_hql_exec2_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof Client_ttypes.ClientException) {
    this.e = args;
...
var HqlService_hql_query_as_arrays_args = function(args) {
  this.ns = null;
  this.command = null;
  if (args) {
    if (args.ns !== undefined && args.ns !== null) {
...
var HqlService_hql_query_as_arrays_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof Client_ttypes.ClientException) {
    this.e = args;
...
var HqlService_hql_query2_args = function(args) {
  this.ns = null;
  this.command = null;
  if (args) {
    if (args.ns !== undefined && args.ns !== null) {
...
var HqlService_hql_query2_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof Client_ttypes.ClientException) {
    this.e = args;
...
var HqlServiceClient = exports.Client = function(output, pClass) {
  this.output = output;
  this.pClass = pClass;
  this._seqid = 0;
  this._reqs = {};
...
HqlServiceClient.prototype.send_hql_exec = function(ns, command, noflush, unbuffered) {
  ...
  var args = new HqlService_hql_exec_args(params);
  try {
...
HqlServiceClient.prototype.send_hql_query = function(ns, command) {
  ...
  var args = new HqlService_hql_query_args(params);
  try {
...
HqlServiceClient.prototype.send_hql_exec_as_arrays = function(ns, command, noflush, unbuffered) {
  ...
  var args = new HqlService_hql_exec_as_arrays_args(params);
  try {
...
HqlServiceClient.prototype.send_hql_exec2 = function(ns, command, noflush, unbuffered) {
  ...
  var args = new HqlService_hql_exec2_args(params);
  try {
...
HqlServiceClient.prototype.send_hql_query_as_arrays = function(ns, command) {
  ...
  var args = new HqlService_hql_query_as_arrays_args(params);
  try {
...
HqlServiceClient.prototype.send_hql_query2 = function(ns, command) {
  ...
  var args = new HqlService_hql_query2_args(params);
  try {
...
var HqlServiceProcessor = exports.Processor = function(handler) {
...
HqlServiceProcessor.prototype.process_hql_exec = function(seqid, input, output) {
  ...
  if (this._handler.hql_exec.length === 4) {
    Q.fcall(this._handler.hql_exec.bind(this._handler),
      args.ns,
      args.command,
      args.noflush,
      args.unbuffered
    ).then(function(result) {
      var result_obj = new HqlService_hql_exec_result({success: result});
      ...
      if (err instanceof Client_ttypes.ClientException) {
        result = new HqlService_hql_exec_result(err);
        output.writeMessageBegin("hql_exec", Thrift.MessageType.REPLY, seqid);
      } else {
    ...
    this._handler.hql_exec(args.ns, args.command, args.noflush, args.unbuffered, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Client_ttypes.ClientException) {
        result_obj = new HqlService_hql_exec_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("hql_exec", Thrift.MessageType.REPLY, seqid);
      } else {
...
HqlServiceProcessor.prototype.process_hql_query = function(seqid, input, output) {
  ...
  if (this._handler.hql_query.length === 2) {
    Q.fcall(this._handler.hql_query.bind(this._handler),
      args.ns,
      args.command
    ).then(function(result) {
      var result_obj = new HqlService_hql_query_result({success: result});
      ...
      var result;
      if (err instanceof Client_ttypes.ClientException) {
        result = new HqlService_hql_query_result(err);
        output.writeMessageBegin("hql_query", Thrift.MessageType.REPLY, seqid);
      } else {
        result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.hql_query(args.ns, args.command, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Client_ttypes.ClientException) {
        result_obj = new HqlService_hql_query_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("hql_query", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("hql_query", Thrift.MessageType.EXCEPTION, seqid);
...
HqlServiceProcessor.prototype.process_hql_exec_as_arrays = function(seqid, input, output) {
  ...
  if (this._handler.hql_exec_as_arrays.length === 4) {
    Q.fcall(this._handler.hql_exec_as_arrays.bind(this._handler),
      args.ns,
      args.command,
      args.noflush,
      args.unbuffered
    ).then(function(result) {
      var result_obj = new HqlService_hql_exec_as_arrays_result({success: result});
      ...
      var result;
      if (err instanceof Client_ttypes.ClientException) {
        result = new HqlService_hql_exec_as_arrays_result(err);
        output.writeMessageBegin("hql_exec_as_arrays", Thrift.MessageType.REPLY, seqid);
      } else {
        result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.hql_exec_as_arrays(args.ns, args.command, args.noflush, args.unbuffered, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Client_ttypes.ClientException) {
        result_obj = new HqlService_hql_exec_as_arrays_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("hql_exec_as_arrays", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("hql_exec_as_arrays", Thrift.MessageType.EXCEPTION, seqid);
...
HqlServiceProcessor.prototype.process_hql_exec2 = function(seqid, input, output) {
  ...
  if (this._handler.hql_exec2.length === 4) {
    Q.fcall(this._handler.hql_exec2.bind(this._handler),
      args.ns,
      args.command,
      args.noflush,
      args.unbuffered
    ).then(function(result) {
      var result_obj = new HqlService_hql_exec2_result({success: result});
      ...
      var result;
      if (err instanceof Client_ttypes.ClientException) {
        result = new HqlService_hql_exec2_result(err);
        output.writeMessageBegin("hql_exec2", Thrift.MessageType.REPLY, seqid);
      } else {
        result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.hql_exec2(args.ns, args.command, args.noflush, args.unbuffered, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Client_ttypes.ClientException) {
        result_obj = new HqlService_hql_exec2_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("hql_exec2", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("hql_exec2", Thrift.MessageType.EXCEPTION, seqid);
...
HqlServiceProcessor.prototype.process_hql_query_as_arrays = function(seqid, input, output) {
  ...
  if (this._handler.hql_query_as_arrays.length === 2) {
    Q.fcall(this._handler.hql_query_as_arrays.bind(this._handler),
      args.ns,
      args.command
    ).then(function(result) {
      var result_obj = new HqlService_hql_query_as_arrays_result({success: result});
      ...
      var result;
      if (err instanceof Client_ttypes.ClientException) {
        result = new HqlService_hql_query_as_arrays_result(err);
        output.writeMessageBegin("hql_query_as_arrays", Thrift.MessageType.REPLY, seqid);
      } else {
        result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.hql_query_as_arrays(args.ns, args.command, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Client_ttypes.ClientException) {
        result_obj = new HqlService_hql_query_as_arrays_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("hql_query_as_arrays", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("hql_query_as_arrays", Thrift.MessageType.EXCEPTION, seqid);
...
HqlServiceProcessor.prototype.process_hql_query2 = function(seqid, input, output) {
  ...
  if (this._handler.hql_query2.length === 2) {
    Q.fcall(this._handler.hql_query2.bind(this._handler),
      args.ns,
      args.command
    ).then(function(result) {
      var result_obj = new HqlService_hql_query2_result({success: result});
      ...
      var result;
      if (err instanceof Client_ttypes.ClientException) {
        result = new HqlService_hql_query2_result(err);
        output.writeMessageBegin("hql_query2", Thrift.MessageType.REPLY, seqid);
      } else {
        result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.hql_query2(args.ns, args.command, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Client_ttypes.ClientException) {
        result_obj = new HqlService_hql_query2_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("hql_query2", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("hql_query2", Thrift.MessageType.EXCEPTION, seqid);
