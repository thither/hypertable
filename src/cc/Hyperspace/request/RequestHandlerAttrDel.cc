...
/** @file
 * Definitions for RequestHandlerAttrDel.
 * This file contains definitions for RequestHandlerAttrDel, an application
...
void RequestHandlerAttrDel::run() {
  ...
  try {
    ...
    cb.error(e.code(), "Error handling ATTRDEL message");
  }
}
