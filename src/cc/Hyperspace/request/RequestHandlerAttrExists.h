 ...
 * This file contains declarations for RequestHandlerAttrExists, an application
 * handler class for unmarshalling request parameters and calling the
 * Master::attr_exists() method.
 */

#ifndef HYPERSPACE_REQUESTHANDLERATTREXISTS_H
#define HYPERSPACE_REQUESTHANDLERATTREXISTS_H
...
namespace Hyperspace {
   ...
   */
  class RequestHandlerAttrExists: public ApplicationHandler {
  public:
     ...
     */
    RequestHandlerAttrExists(Comm *comm, Master *master, uint64_t session_id,
                             EventPtr &event)
     ...
     * object and passes them into a call to Master::attr_exists().  See
     * Protocol::create_attr_exists_request() for the request parameter
     * encoding format.
     */
    virtual void run();
...
#endif // HYPERSPACE_REQUESTHANDLERATTREXISTS_H
