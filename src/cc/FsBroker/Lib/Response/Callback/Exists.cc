...
/// @file
/// Definitions for Exists response callback.
/// This file contains definitions for Exists, a response callback class used
...
int Callback::Exists::response(bool exists) {
  CommHeader header;
  header.initialize_from_request_header(m_event->header);
  Parameters::Exists params(exists);
