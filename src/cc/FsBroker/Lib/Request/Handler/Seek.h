...
/// This file contains declarations for Seek, a server-side request handler
/// used to invoke the <i>seek</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Seek_h
#define FsBroker_Lib_Request_Handler_Seek_h
...
namespace Handler {
  ...
  /// Application handler for <i>seek</i> function.
  class Seek : public ApplicationHandler {
  ...
  public:
    ...
    /// calls the seek function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Seek_h
