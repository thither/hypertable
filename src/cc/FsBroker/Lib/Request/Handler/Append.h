...
/// This file contains declarations for Append, a server-side request handler
/// used to invoke the <i>append</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Append_h
#define FsBroker_Lib_Request_Handler_Append_h
...
namespace Handler {
  ...
  class Append : public ApplicationHandler {
  ...
  public:
    ...
    /// calls the append function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Append_h
