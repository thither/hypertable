...
/// This file contains declarations for Pread, a server-side request handler
/// used to invoke the <i>pread</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Pread_h
#define FsBroker_Lib_Request_Handler_Pread_h
...
namespace Handler {
  ...
  /// Application handler for <i>pread</i> function.
  class Pread : public ApplicationHandler {
  public:
    ...
    Pread(Comm *comm, Broker *broker, EventPtr &event)
    ...
    /// calls the pread function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Pread_h
