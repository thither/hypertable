...
/// This file contains declarations for Mkdirs, a server-side request handler
/// used to invoke the <i>mkdirs</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Mkdirs_h
#define FsBroker_Lib_Request_Handler_Mkdirs_h
...
namespace Handler {
  ...
  /// Application handler for <i>mkdirs</i> function.
  class Mkdirs : public ApplicationHandler {
  public:
    ...
    /// calls the mkdirs function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Mkdirs_h
