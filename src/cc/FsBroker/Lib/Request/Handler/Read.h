...
/// This file contains declarations for Read, a server-side request handler
/// used to invoke the <i>read</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Read_h
#define FsBroker_Lib_Request_Handler_Read_h
...
namespace Handler {
  ...
  class Read : public ApplicationHandler {
  public:
    ...
    /// calls the read function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Read_h
