...
/// This file contains declarations for Close, a server-side request handler
/// used to invoke the <i>close</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Close_h
#define FsBroker_Lib_Request_Handler_Close_h
...
namespace Handler {
  ...
  /// Application handler for <i>close</i> function.
  class Close : public ApplicationHandler {
  public:
    ...
    Close(Comm *comm, Broker *broker, EventPtr &event)
    ...
    /// calls the close function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Close_h
