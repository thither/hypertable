...
/// This file contains declarations for Open, a server-side request handler
/// used to invoke the <i>open</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Open_h
#define FsBroker_Lib_Request_Handler_Open_h
...
namespace Handler {
  ...
  class Open : public ApplicationHandler {
  public:
    ...
    Open(Comm *comm, Broker *broker, EventPtr &event)
    ...
    /// calls the open function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Open_h
