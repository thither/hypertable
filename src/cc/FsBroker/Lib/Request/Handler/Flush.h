...
/// This file contains declarations for Flush, a server-side request handler
/// used to invoke the <i>flush</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Flush_h
#define FsBroker_Lib_Request_Handler_Flush_h
...
namespace Handler {
  ...
  /// Application handler for <i>flush</i> function.
  class Flush : public ApplicationHandler {
  ...
  public:
    ...
    Flush(Comm *comm, Broker *broker, EventPtr &event)
    ...
    /// calls the flush function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Flush_h
