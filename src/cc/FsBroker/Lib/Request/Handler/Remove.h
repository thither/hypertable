...
/// This file contains declarations for Remove, a server-side request handler
/// used to invoke the <i>remove</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Remove_h
#define FsBroker_Lib_Request_Handler_Remove_h
...
namespace Handler {
  ...
  /// Application handler for <i>remove</i> function.
  class Remove : public ApplicationHandler {
  public:
    ...
    Remove(Comm *comm, Broker *broker, EventPtr &event)
    ...
    /// calls the remove function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Remove_h
