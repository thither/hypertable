...
/// This file contains declarations for Rmdir, a server-side request handler
/// used to invoke the <i>rmdir</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Rmdir_h
#define FsBroker_Lib_Request_Handler_Rmdir_h
...
namespace Handler {
  ...
  /// Application handler for <i>rmdir</i> function.
  class Rmdir : public ApplicationHandler {
  ...
  public:
    ...
    /// calls the rmdir function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Rmdir_h
