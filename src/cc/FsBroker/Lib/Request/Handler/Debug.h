...
/// This file contains declarations for Debug, a server-side request handler
/// used to invoke the <i>debug</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Debug_h
#define FsBroker_Lib_Request_Handler_Debug_h
...
namespace Handler {
  ...
  /// Application handler for <i>debug</i> function.
  class Debug : public ApplicationHandler {
  public:
    ...
    /// calls the debug function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Debug_h
