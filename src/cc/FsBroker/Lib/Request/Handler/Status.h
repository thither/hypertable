...
/// This file contains declarations for Status, a server-side request handler
/// used to invoke the <i>status</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Status_h
#define FsBroker_Lib_Request_Handler_Status_h
...
namespace Handler {
  ...
  /// Application handler for <i>status</i> function.
...
#endif // FsBroker_Lib_Request_Handler_Status_h
