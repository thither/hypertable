...
/// This file contains declarations for Exists, a server-side request handler
/// used to invoke the <i>exists</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Exists_h
#define FsBroker_Lib_Request_Handler_Exists_h
...
namespace Handler {
  ...
  class Exists : public ApplicationHandler {
  public:
    ...
    /// calls the exists function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Exists_h
