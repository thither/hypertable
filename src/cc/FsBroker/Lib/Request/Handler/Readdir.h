...
/// This file contains declarations for Readdir, a server-side request handler
/// used to invoke the <i>readdir</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Readdir_h
#define FsBroker_Lib_Request_Handler_Readdir_h
...
namespace Handler {
  ...
  class Readdir : public ApplicationHandler {
  public:
    ...
    Readdir(Comm *comm, Broker *broker, EventPtr &event)
    ...
    /// calls the readdir function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Readdir_h
