...
/// This file contains declarations for Length, a server-side request handler
/// used to invoke the <i>length</i> function of a file system broker.

#ifndef FsBroker_Lib_Request_Handler_Length_h
#define FsBroker_Lib_Request_Handler_Length_h
...
namespace Handler {
  ...
  class Length : public ApplicationHandler {
  ...
  public:
    ...
    Length(Comm *comm, Broker *broker, EventPtr &event)
    ...
    /// calls the length function of #m_broker.
    virtual void run();
...
#endif // FsBroker_Lib_Request_Handler_Length_h
