...
#ifndef FsBroker_Lib_Request_Parameters_Readdir_h
#define FsBroker_Lib_Request_Parameters_Readdir_h
...
namespace Parameters {
  ...
  /// %Request parameters for <i>readdir</i> requests.
  ...
  public:
    ...
    Readdir(const std::string &dirname) : m_dirname(dirname) {}
...
#endif // FsBroker_Lib_Request_Parameters_Readdir_h
