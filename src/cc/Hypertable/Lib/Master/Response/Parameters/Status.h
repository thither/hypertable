...
#ifndef Hypertable_Lib_Master_Response_Parameters_Status_h
#define Hypertable_Lib_Master_Response_Parameters_Status_h
...
#endif // Hypertable_Lib_Master_Response_Parameters_Status_h
