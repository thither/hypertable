...
/// @file
/// Definitions for CreateNamespace request parameters.
/// This file contains definitions for CreateNamespace, a class for encoding and
...
CreateNamespace::CreateNamespace(const std::string &name, int32_t flags)
...
/// <tr>
/// <td>vstr</td>
/// <td>Pathname of namespace to create</td>
/// </tr>
/// <tr>
/// <td>i32</td>
/// <td>Create flags (see NamespaceFlag)</td>
/// </tr>
/// </table>
...
void CreateNamespace::decode_internal(uint8_t version, const uint8_t **bufp,
			     size_t *remainp) {
  m_name.clear();
