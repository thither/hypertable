...
/// @file
/// Definitions for ReplayComplete request parameters.
/// This file contains definitions for ReplayComplete, a class for encoding and
/// decoding paramters to the <i>replay complete</i> %Master operation.

#include <Common/Compat.h>

#include "ReplayComplete.h"
...
uint8_t ReplayComplete::encoding_version() const {
  return 1;
}

size_t ReplayComplete::encoded_length_internal() const {
...
/// </tr>
/// </table>
void ReplayComplete::encode_internal(uint8_t **bufp) const {
...
void ReplayComplete::decode_internal(uint8_t version, const uint8_t **bufp,
                                   size_t *remainp) {
