...
/// This file contains declarations for PhantomCommitComplete, a class for encoding and
/// decoding paramters to the <i>phantom commit complete</i> %Master operation.

#ifndef Hypertable_Lib_Master_Request_Parameters_PhantomCommitComplete_h
#define Hypertable_Lib_Master_Request_Parameters_PhantomCommitComplete_h
...
namespace Parameters {
  ...
  /// %Request parameters for <i>phantom commit complete</i> operation.
  class PhantomCommitComplete : public Serializable {
  public:
    ...
    /// @param location Proxy name of %RangeServer whose log is being recovered
    /// @param plan_generation Recovery plan generation
    /// @param error %Error code
    /// @param message %Error message
    PhantomCommitComplete(int64_t op_id, const string &location, int32_t plan_generation,
    ...
    /// @return Proxy name of %RangeServer whose log is being recovered
...
#endif // Hypertable_Lib_Master_Request_Parameters_PhantomCommitComplete_h
