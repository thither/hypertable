...
/// This file contains declarations for DropRange, a class for encoding and
/// decoding paramters to the <i>drop range</i> %RangeServer function.

#ifndef Hypertable_Lib_RangeServer_Request_Parameters_DropRange_h
#define Hypertable_Lib_RangeServer_Request_Parameters_DropRange_h
...
namespace Parameters {
  ...
  /// %Request parameters for <i>drop range</i> function.
  class DropRange : public Serializable {
  public:
    ...
    DropRange(const TableIdentifier &table, const RangeSpec &range_spec)
...
#endif // Hypertable_Lib_RangeServer_Request_Parameters_DropRange_h
