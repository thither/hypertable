...
/// @file
/// Definitions for PhantomPrepareRanges request parameters.
/// This file contains definitions for PhantomPrepareRanges, a class for
/// encoding and decoding paramters to the <i>phantom prepare ranges</i>
...
uint8_t PhantomPrepareRanges::encoding_version() const {
  return 1;
}

size_t PhantomPrepareRanges::encoded_length_internal() const {
...
/// </table>
void PhantomPrepareRanges::encode_internal(uint8_t **bufp) const {
...
void PhantomPrepareRanges::decode_internal(uint8_t version, const uint8_t **bufp,
                                           size_t *remainp) {
