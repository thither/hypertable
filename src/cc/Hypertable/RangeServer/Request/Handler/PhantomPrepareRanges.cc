...
#include <Hypertable/Lib/RangeServer/Request/Parameters/PhantomPrepareRanges.h>
...
void PhantomPrepareRanges::run() {
  ...
  try {
    ...
    Lib::RangeServer::Request::Parameters::PhantomPrepareRanges params;
    params.decode(&ptr, &remain);
    m_range_server->phantom_prepare_ranges(&cb, params.op_id(),
                                           params.location(),
