...
#ifndef Hypertable_RangeServer_Request_Handler_Dump_h
#define Hypertable_RangeServer_Request_Handler_Dump_h
...
namespace Handler {
  ...
  class Dump : public ApplicationHandler {
  public:
...
#endif // Hypertable_RangeServer_Request_Handler_Dump_h
