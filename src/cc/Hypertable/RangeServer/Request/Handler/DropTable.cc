...
#include <Hypertable/Lib/RangeServer/Request/Parameters/DropTable.h>
...
void DropTable::run() {
  ...
  try {
    ...
    Lib::RangeServer::Request::Parameters::DropTable params;
    params.decode(&ptr, &remain);
    m_range_server->drop_table(&cb, params.table());
  }
  catch (Exception &e) {
