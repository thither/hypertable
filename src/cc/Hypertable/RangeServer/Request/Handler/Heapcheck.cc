...
#include <Hypertable/Lib/RangeServer/Request/Parameters/Heapcheck.h>
...
void Heapcheck::run() {
  ...
  try {
    ...
    Lib::RangeServer::Request::Parameters::Heapcheck params;
    params.decode(&ptr, &remain);
    m_range_server->heapcheck(&cb, params.fname());
  }
  catch (Exception &e) {
