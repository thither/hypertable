...
#include <Hypertable/Lib/RangeServer/Request/Parameters/UpdateSchema.h>
...
void UpdateSchema::run() {
  ...
  try {
    ...
    Lib::RangeServer::Request::Parameters::UpdateSchema params;
    params.decode(&ptr, &remain);
    m_range_server->update_schema(&cb, params.table(), params.schema());
  }
  catch (Exception &e) {
