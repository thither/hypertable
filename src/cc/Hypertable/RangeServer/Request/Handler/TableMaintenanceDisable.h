...
#ifndef Hypertable_RangeServer_Request_Handler_TableMaintenanceDisable_h
#define Hypertable_RangeServer_Request_Handler_TableMaintenanceDisable_h
...
namespace Handler {
  ...
  class TableMaintenanceDisable : public ApplicationHandler {
  public:
    ...
    TableMaintenanceDisable(Comm *comm, Apps::RangeServer *rs,
                                          EventPtr &event)
...
#endif // Hypertable_RangeServer_Request_Handler_TableMaintenanceDisable_h
