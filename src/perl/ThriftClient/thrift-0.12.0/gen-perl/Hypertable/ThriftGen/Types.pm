...
sub write {
  ...
  if (defined $self->{start_row}) {
    $xfer += $output->writeFieldBegin('start_row', Thrift::TType::STRING, 1);
    $xfer += $output->writeString($self->{start_row});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{start_inclusive}) {
    $xfer += $output->writeFieldBegin('start_inclusive', Thrift::TType::BOOL, 2);
    $xfer += $output->writeBool($self->{start_inclusive});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{end_row}) {
    $xfer += $output->writeFieldBegin('end_row', Thrift::TType::STRING, 3);
    $xfer += $output->writeString($self->{end_row});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{end_inclusive}) {
    $xfer += $output->writeFieldBegin('end_inclusive', Thrift::TType::BOOL, 4);
    $xfer += $output->writeBool($self->{end_inclusive});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{start_row_binary}) {
    $xfer += $output->writeFieldBegin('start_row_binary', Thrift::TType::STRING, 5);
    $xfer += $output->writeString($self->{start_row_binary});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{end_row_binary}) {
    $xfer += $output->writeFieldBegin('end_row_binary', Thrift::TType::STRING, 6);
...
sub write {
  ...
  if (defined $self->{start_column}) {
    $xfer += $output->writeFieldBegin('start_column', Thrift::TType::STRING, 2);
    $xfer += $output->writeString($self->{start_column});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{start_inclusive}) {
    $xfer += $output->writeFieldBegin('start_inclusive', Thrift::TType::BOOL, 3);
    $xfer += $output->writeBool($self->{start_inclusive});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{end_row}) {
    $xfer += $output->writeFieldBegin('end_row', Thrift::TType::STRING, 4);
    $xfer += $output->writeString($self->{end_row});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{end_column}) {
    $xfer += $output->writeFieldBegin('end_column', Thrift::TType::STRING, 5);
    $xfer += $output->writeString($self->{end_column});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{end_inclusive}) {
    $xfer += $output->writeFieldBegin('end_inclusive', Thrift::TType::BOOL, 6);
    $xfer += $output->writeBool($self->{end_inclusive});
    $xfer += $output->writeFieldEnd();
  }
  $xfer += $output->writeFieldStop();
...
sub write {
  ...
  if (defined $self->{column_qualifier}) {
    $xfer += $output->writeFieldBegin('column_qualifier', Thrift::TType::STRING, 2);
    $xfer += $output->writeString($self->{column_qualifier});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{operation}) {
    $xfer += $output->writeFieldBegin('operation', Thrift::TType::I32, 3);
...
sub read {
  ...
  while (1)
  {
    ...
    SWITCH: for($fid)
    {
      /^1$/ && do{      if ($ftype == Thrift::TType::LIST) {
        {
          ...
          {
            my $elem5 = undef;
            $elem5 = Hypertable::ThriftGen::RowInterval->new();
      ...
      /^2$/ && do{      if ($ftype == Thrift::TType::LIST) {
        {
          ...
          {
            my $elem11 = undef;
            $elem11 = Hypertable::ThriftGen::CellInterval->new();
      ...
      last; };
      /^17$/ && do{      if ($ftype == Thrift::TType::LIST) {
        {
          my $_size18 = 0;
          ...
          {
            my $elem23 = undef;
            $elem23 = Hypertable::ThriftGen::ColumnPredicate->new();
      ...
      last; };
      /^19$/ && do{      if ($ftype == Thrift::TType::BOOL) {
...
sub write {
  ...
  if (defined $self->{row_intervals}) {
    $xfer += $output->writeFieldBegin('row_intervals', Thrift::TType::LIST, 1);
    {
      $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{row_intervals}}));
      {
  ...
  if (defined $self->{cell_intervals}) {
    $xfer += $output->writeFieldBegin('cell_intervals', Thrift::TType::LIST, 2);
    {
      $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{cell_intervals}}));
      {
  ...
  if (defined $self->{return_deletes}) {
    $xfer += $output->writeFieldBegin('return_deletes', Thrift::TType::BOOL, 3);
    $xfer += $output->writeBool($self->{return_deletes});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{versions}) {
    $xfer += $output->writeFieldBegin('versions', Thrift::TType::I32, 4);
    $xfer += $output->writeI32($self->{versions});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{row_limit}) {
    $xfer += $output->writeFieldBegin('row_limit', Thrift::TType::I32, 5);
    $xfer += $output->writeI32($self->{row_limit});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{start_time}) {
    $xfer += $output->writeFieldBegin('start_time', Thrift::TType::I64, 6);
    $xfer += $output->writeI64($self->{start_time});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{end_time}) {
    $xfer += $output->writeFieldBegin('end_time', Thrift::TType::I64, 7);
    $xfer += $output->writeI64($self->{end_time});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{columns}) {
    $xfer += $output->writeFieldBegin('columns', Thrift::TType::LIST, 8);
    {
  ...
  if (defined $self->{keys_only}) {
    $xfer += $output->writeFieldBegin('keys_only', Thrift::TType::BOOL, 9);
    $xfer += $output->writeBool($self->{keys_only});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{cell_limit_per_family}) {
    $xfer += $output->writeFieldBegin('cell_limit_per_family', Thrift::TType::I32, 10);
    $xfer += $output->writeI32($self->{cell_limit_per_family});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{row_regexp}) {
    $xfer += $output->writeFieldBegin('row_regexp', Thrift::TType::STRING, 11);
    $xfer += $output->writeString($self->{row_regexp});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{value_regexp}) {
    $xfer += $output->writeFieldBegin('value_regexp', Thrift::TType::STRING, 12);
    $xfer += $output->writeString($self->{value_regexp});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{scan_and_filter_rows}) {
    $xfer += $output->writeFieldBegin('scan_and_filter_rows', Thrift::TType::BOOL, 13);
    $xfer += $output->writeBool($self->{scan_and_filter_rows});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{cell_limit}) {
    $xfer += $output->writeFieldBegin('cell_limit', Thrift::TType::I32, 14);
    $xfer += $output->writeI32($self->{cell_limit});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{row_offset}) {
    $xfer += $output->writeFieldBegin('row_offset', Thrift::TType::I32, 15);
    $xfer += $output->writeI32($self->{row_offset});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{cell_offset}) {
    $xfer += $output->writeFieldBegin('cell_offset', Thrift::TType::I32, 16);
    $xfer += $output->writeI32($self->{cell_offset});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{column_predicates}) {
    $xfer += $output->writeFieldBegin('column_predicates', Thrift::TType::LIST, 17);
    {
      $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{column_predicates}}));
      {
  ...
  if (defined $self->{do_not_cache}) {
    $xfer += $output->writeFieldBegin('do_not_cache', Thrift::TType::BOOL, 18);
    $xfer += $output->writeBool($self->{do_not_cache});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{and_column_predicates}) {
    $xfer += $output->writeFieldBegin('and_column_predicates', Thrift::TType::BOOL, 19);
...
sub write {
  ...
  if (defined $self->{column_qualifier}) {
    $xfer += $output->writeFieldBegin('column_qualifier', Thrift::TType::STRING, 3);
    $xfer += $output->writeString($self->{column_qualifier});
    $xfer += $output->writeFieldEnd();
  }
  ...
  if (defined $self->{revision}) {
    $xfer += $output->writeFieldBegin('revision', Thrift::TType::I64, 5);
    $xfer += $output->writeI64($self->{revision});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{flag}) {
    $xfer += $output->writeFieldBegin('flag', Thrift::TType::I32, 6);
...
sub write {
  ...
  if (defined $self->{appname}) {
    $xfer += $output->writeFieldBegin('appname', Thrift::TType::STRING, 1);
    $xfer += $output->writeString($self->{appname});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{flush_interval}) {
    $xfer += $output->writeFieldBegin('flush_interval', Thrift::TType::I32, 2);
...
sub write {
  ...
  if (defined $self->{key}) {
    $xfer += $output->writeFieldBegin('key', Thrift::TType::STRUCT, 1);
      ...
      /^7$/ && do{      if ($ftype == Thrift::TType::LIST) {
        {
          ...
          {
            my $elem33 = undef;
            $elem33 = Hypertable::ThriftGen::Cell->new();
...
sub write {
  ...
  if (defined $self->{is_empty}) {
    $xfer += $output->writeFieldBegin('is_empty', Thrift::TType::BOOL, 1);
    $xfer += $output->writeBool($self->{is_empty});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{id}) {
    $xfer += $output->writeFieldBegin('id', Thrift::TType::I64, 2);
    $xfer += $output->writeI64($self->{id});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{is_scan}) {
    $xfer += $output->writeFieldBegin('is_scan', Thrift::TType::BOOL, 3);
    $xfer += $output->writeBool($self->{is_scan});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{is_error}) {
    $xfer += $output->writeFieldBegin('is_error', Thrift::TType::BOOL, 4);
    $xfer += $output->writeBool($self->{is_error});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{error}) {
    $xfer += $output->writeFieldBegin('error', Thrift::TType::I32, 5);
    $xfer += $output->writeI32($self->{error});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{error_msg}) {
    $xfer += $output->writeFieldBegin('error_msg', Thrift::TType::STRING, 6);
    $xfer += $output->writeString($self->{error_msg});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{cells}) {
    $xfer += $output->writeFieldBegin('cells', Thrift::TType::LIST, 7);
    {
  ...
  if (defined $self->{cells}) {
    $xfer += $output->writeFieldBegin('cells', Thrift::TType::LIST, 7);
    {
      $xfer += $output->writeListBegin(Thrift::TType::LIST, scalar(@{$self->{cells}}));
      {
        ...
        {
          {
            $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{${iter47}}));
            {
...
sub write {
  ...
  if (defined $self->{cells}) {
    $xfer += $output->writeFieldBegin('cells', Thrift::TType::STRING, 7);
...
sub write {
  ...
  if (defined $self->{is_namespace}) {
    $xfer += $output->writeFieldBegin('is_namespace', Thrift::TType::BOOL, 2);
...
sub write {
  ...
  if (defined $self->{end_row}) {
    $xfer += $output->writeFieldBegin('end_row', Thrift::TType::STRING, 2);
    $xfer += $output->writeString($self->{end_row});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{location}) {
    $xfer += $output->writeFieldBegin('location', Thrift::TType::STRING, 3);
    $xfer += $output->writeString($self->{location});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{ip_address}) {
    $xfer += $output->writeFieldBegin('ip_address', Thrift::TType::STRING, 4);
    $xfer += $output->writeString($self->{ip_address});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{hostname}) {
    $xfer += $output->writeFieldBegin('hostname', Thrift::TType::STRING, 5);
...
sub write {
  ...
  if (defined $self->{max_versions}) {
    $xfer += $output->writeFieldBegin('max_versions', Thrift::TType::I32, 1);
    $xfer += $output->writeI32($self->{max_versions});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{ttl}) {
    $xfer += $output->writeFieldBegin('ttl', Thrift::TType::I32, 2);
    $xfer += $output->writeI32($self->{ttl});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{time_order_desc}) {
    $xfer += $output->writeFieldBegin('time_order_desc', Thrift::TType::BOOL, 3);
    $xfer += $output->writeBool($self->{time_order_desc});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{counter}) {
    $xfer += $output->writeFieldBegin('counter', Thrift::TType::BOOL, 4);
  ...
  while (1)
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^8$/ && do{      if ($ftype == Thrift::TType::STRUCT) {
        $self->{options} = Hypertable::ThriftGen::ColumnFamilyOptions->new();
...
sub write {
  ...
  if (defined $self->{access_group}) {
    $xfer += $output->writeFieldBegin('access_group', Thrift::TType::STRING, 2);
    $xfer += $output->writeString($self->{access_group});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{deleted}) {
    $xfer += $output->writeFieldBegin('deleted', Thrift::TType::BOOL, 3);
    $xfer += $output->writeBool($self->{deleted});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{generation}) {
    $xfer += $output->writeFieldBegin('generation', Thrift::TType::I64, 4);
    $xfer += $output->writeI64($self->{generation});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{id}) {
    $xfer += $output->writeFieldBegin('id', Thrift::TType::I32, 5);
    $xfer += $output->writeI32($self->{id});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{value_index}) {
    $xfer += $output->writeFieldBegin('value_index', Thrift::TType::BOOL, 6);
    $xfer += $output->writeBool($self->{value_index});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{qualifier_index}) {
    $xfer += $output->writeFieldBegin('qualifier_index', Thrift::TType::BOOL, 7);
    $xfer += $output->writeBool($self->{qualifier_index});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{options}) {
    $xfer += $output->writeFieldBegin('options', Thrift::TType::STRUCT, 8);
...
sub read {
  ...
  while (1)
  {
    ...
    SWITCH: for($fid)
    {
      /^1$/ && do{      if ($ftype == Thrift::TType::I16) {
...
sub write {
  ...
  if (defined $self->{replication}) {
    $xfer += $output->writeFieldBegin('replication', Thrift::TType::I16, 1);
    $xfer += $output->writeI16($self->{replication});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{blocksize}) {
    $xfer += $output->writeFieldBegin('blocksize', Thrift::TType::I32, 2);
    $xfer += $output->writeI32($self->{blocksize});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{compressor}) {
    $xfer += $output->writeFieldBegin('compressor', Thrift::TType::STRING, 3);
    $xfer += $output->writeString($self->{compressor});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{bloom_filter}) {
    $xfer += $output->writeFieldBegin('bloom_filter', Thrift::TType::STRING, 4);
    $xfer += $output->writeString($self->{bloom_filter});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{in_memory}) {
    $xfer += $output->writeFieldBegin('in_memory', Thrift::TType::BOOL, 5);
  ...
  while (1)
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^3$/ && do{      if ($ftype == Thrift::TType::STRUCT) {
        $self->{options} = Hypertable::ThriftGen::AccessGroupOptions->new();
        $xfer += $self->{options}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
      ...
      /^4$/ && do{      if ($ftype == Thrift::TType::STRUCT) {
        $self->{defaults} = Hypertable::ThriftGen::ColumnFamilyOptions->new();
...
sub write {
  ...
  if (defined $self->{generation}) {
    $xfer += $output->writeFieldBegin('generation', Thrift::TType::I64, 2);
    $xfer += $output->writeI64($self->{generation});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{options}) {
    $xfer += $output->writeFieldBegin('options', Thrift::TType::STRUCT, 3);
    $xfer += $self->{options}->write($output);
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{defaults}) {
    $xfer += $output->writeFieldBegin('defaults', Thrift::TType::STRUCT, 4);
  ...
  while (1)
  {
    ...
    SWITCH: for($fid)
    {
      /^1$/ && do{      if ($ftype == Thrift::TType::MAP) {
        {
          ...
          {
            my $key54 = '';
            my $val55 = Hypertable::ThriftGen::AccessGroupSpec->new();
            $xfer += $input->readString(\$key54);
            $val55 = Hypertable::ThriftGen::AccessGroupSpec->new();
      ...
      /^2$/ && do{      if ($ftype == Thrift::TType::MAP) {
        {
          ...
          {
            my $key61 = '';
            my $val62 = Hypertable::ThriftGen::ColumnFamilySpec->new();
            $xfer += $input->readString(\$key61);
            $val62 = Hypertable::ThriftGen::ColumnFamilySpec->new();
      ...
      /^6$/ && do{      if ($ftype == Thrift::TType::STRUCT) {
        $self->{access_group_defaults} = Hypertable::ThriftGen::AccessGroupOptions->new();
      ...
      /^7$/ && do{      if ($ftype == Thrift::TType::STRUCT) {
        $self->{column_family_defaults} = Hypertable::ThriftGen::ColumnFamilyOptions->new();
...
sub write {
  ...
  if (defined $self->{access_groups}) {
    $xfer += $output->writeFieldBegin('access_groups', Thrift::TType::MAP, 1);
    {
      $xfer += $output->writeMapBegin(Thrift::TType::STRING, Thrift::TType::STRUCT, scalar(keys %{$self->{access_groups}}));
      {
  ...
  if (defined $self->{column_families}) {
    $xfer += $output->writeFieldBegin('column_families', Thrift::TType::MAP, 2);
    {
      $xfer += $output->writeMapBegin(Thrift::TType::STRING, Thrift::TType::STRUCT, scalar(keys %{$self->{column_families}}));
      {
  ...
  if (defined $self->{generation}) {
    $xfer += $output->writeFieldBegin('generation', Thrift::TType::I64, 3);
    $xfer += $output->writeI64($self->{generation});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{version}) {
    $xfer += $output->writeFieldBegin('version', Thrift::TType::I32, 4);
    $xfer += $output->writeI32($self->{version});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{group_commit_interval}) {
    $xfer += $output->writeFieldBegin('group_commit_interval', Thrift::TType::I32, 5);
    $xfer += $output->writeI32($self->{group_commit_interval});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{access_group_defaults}) {
    $xfer += $output->writeFieldBegin('access_group_defaults', Thrift::TType::STRUCT, 6);
    $xfer += $self->{access_group_defaults}->write($output);
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{column_family_defaults}) {
    $xfer += $output->writeFieldBegin('column_family_defaults', Thrift::TType::STRUCT, 7);
