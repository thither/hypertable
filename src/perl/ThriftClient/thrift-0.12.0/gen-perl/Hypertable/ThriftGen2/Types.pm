      ...
      /^2$/ && do{      if ($ftype == Thrift::TType::LIST) {
        {
          ...
          {
            my $elem11 = undef;
            $elem11 = Hypertable::ThriftGen::Cell->new();
...
sub write {
  ...
  if (defined $self->{results}) {
    $xfer += $output->writeFieldBegin('results', Thrift::TType::LIST, 1);
    {
      $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{results}}));
      {
  ...
  if (defined $self->{scanner}) {
    $xfer += $output->writeFieldBegin('scanner', Thrift::TType::I64, 3);
    $xfer += $output->writeI64($self->{scanner});
    $xfer += $output->writeFieldEnd();
  }
  if (defined $self->{mutator}) {
    $xfer += $output->writeFieldBegin('mutator', Thrift::TType::I64, 4);
  ...
  if (defined $self->{cells}) {
    $xfer += $output->writeFieldBegin('cells', Thrift::TType::LIST, 2);
    {
      $xfer += $output->writeListBegin(Thrift::TType::LIST, scalar(@{$self->{cells}}));
      {
        ...
        {
          {
            $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{${iter33}}));
            {
  ...
  if (defined $self->{cells}) {
    $xfer += $output->writeFieldBegin('cells', Thrift::TType::LIST, 2);
    {
      $xfer += $output->writeListBegin(Thrift::TType::LIST, scalar(@{$self->{cells}}));
      {
        ...
        {
          {
            $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{${iter54}}));
            {
